...
public class AddressController {
    ...
    @ApiOperation("新增或者修改地址")
    @PostMapping()
    public R<Void> addOrUpdateAddress(@RequestBody AddressDTO addressDTO) {
    ...
    public R<Void> deleteAddress(@ApiParam("地址id") @PathVariable("addressId") Long id) {
